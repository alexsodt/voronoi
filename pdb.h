...
void printATOM( FILE *toFile, int bead, int res, struct atom_rec *atrec, double aux=0 );
void printATOM( char *toFile, int bead, int res, struct atom_rec *atrec, double aux=0 );
